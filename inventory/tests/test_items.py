...
# 		self.item1 = Item.objects.create(is_active=True, category='Amplifier', brand='Boston', model='BP20', name='Item1', description='Insert long description here', item_code='S-1-5099', unit_cost='1000', date=timezone.now(), supplier=self.supplier1)
